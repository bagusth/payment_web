...
$tagihan = query("SELECT * FROM dev_tagihan_m");
?>
<html>
	<head>
	...
	<body>
		<div class="d-flex" id="wrapper">
			...
			<div class="container-fluid">
				...
				<a class="btn btn-success" href="tambah-tagihan.php">Tambah Data</a>
				...
				<table id="dtBasicExample" class="table table-striped table-bordered autoWidth" cellspacing="0" width="100%">
					...
					<tbody>
						<tr>
							...
							<td>
								<a class="btn btn-warning" href="edit-tagihan.php?no_tagihan=<?= $row["no_tagihan"]; ?>">Change</a>
								<a class="btn btn-danger" href="delete-tag.php?no_tagihan=<?= $row["no_tagihan"]; ?>" onclick="return confirm('Are You Serious?');">Delete</a>
							</td>
						</tr>
					</tbody>
					<?php endforeach; ?>
