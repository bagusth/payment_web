			...
			<div class="container-fluid">
				...
				<div class="container">
					<form action="" method="post">
						<input type="hidden" name="no_tagihan" value="<?=$detail["no_tagihan"];?>" />
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<select name="kode_jenis">
									...
									<option value="<?=$row["kode_jenis"]?>" <?= @$detail['kode_jenis'] == $row['kode_jenis'] ? 'selected' : ''?>><?=$row["kode_jenis"]?> - <?=$row["nama"]?></option>
									<?php endforeach ?>
								</select>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="nilai" name="nilai" value="<?= $detail['nilai'] ?>">
							</div>
						</div>
